...
解决：应该是权限问题，但是权限已经在manifest中给了，只能认为是MIUI的小坑吧，但是在MainActivity中可以获取音乐文件，所以直接在MainActivity中获取音乐文件然后生成MediaPlayer传给后台服务，便解决了该问题。
...
2. 学会简单的多线程编程，可以使用Handler更新UI（进度条更新）。
